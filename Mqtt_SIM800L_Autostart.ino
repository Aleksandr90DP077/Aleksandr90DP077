...
const char MQTT_user[10] = "admin";      // api.cloudmqtt.com > Details > User  
const char MQTT_pass[15] = "admin123";  // api.cloudmqtt.com > Details > Password
...
String call_phone=  "+37433005509";        // телефон входящего вызова  для управления DTMF
String call_phone2= "+37433005509";        // телефон для автосброса могут работать не корректно
String call_phone3= "+34733005509";        // телефон для автосброса 
String call_phone4= "+37433005509";        // телефон для автосброса 
String APN = "internet.beeline.am";             // тчка доступа выхода в интернет вашего сотового оператора
